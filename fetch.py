#!/usr/bin/env python3
"""
Recuperation des codes promo Castorama depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/castorama.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/castorama.fr"
STORE_NAME = "Castorama"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Castorama depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-castorama)"
    }
    try:
